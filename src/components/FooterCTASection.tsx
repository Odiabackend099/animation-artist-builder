...
const FooterCTASection = () => {
  ...
  return (
    <section id="footer-cta" className="py-24 bg-surface-primary border-t border-border">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex justify-center">
          <Button className="bg-brand-primary hover:bg-brand-primary/90 text-background text-lg px-8" onClick={() => navigate(NAV.routes.auth)}>Start Free Trial Now</Button>
        </div>
